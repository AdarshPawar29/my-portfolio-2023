      ...
      <div className="container">
        <div className="roww">
          ...
          <div className="resumo_fn_main_title">
            ...
            <p className="desc">
              {`I build successful responsive websites that are quick to load, simple to use, and constructed according to best practises. Front-end programming, Back-end, small- and medium-sized web apps, unique plugins, features, animations, and the creation of interactive layouts are my primary areas of expertise. a person who keeps things organised, solves problems, and works independently with great attention to detail. fan of English literature, TV shows, and outdoor activities. Working on challenging projects with inspiring individuals and being interested in the entire frontend spectrum.`}
            </p>
          </div>
          {/* /Main Title */}
          {/* About Information */}
          <div className="resumo_fn_about_info">
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    <th>Email</th>
                    <th>
                      <a href="mailto:adarshpawar28@gmail.com">
            ...
            <div className="about_right">
              ...
              <div className="resumo_fn_cv_btn">
                <a href="img/Adarsh's-Resume.pdf" download="Adarsh's Resume">
                  <span className="icon">
                    <svg
                      ...
                      <div className="item">
                        ...
                        <p>
                          <ul className="experience-list">
                            ...
                            <li>
                              Synchronization with other teams (Backend, UI/UX,
                              Security) while implementing new features. Client
                              communication in terms of Scrum.
                            </li>
                          </ul>{" "}
                        </p>
                      </div>
                  ...
                  <ul>
                    ...
                    <li>
                      <div className="item">
                        <div className="item_top">
                          ...
                          <span>( 07/2016 — 05/2020 )</span>
                        </div>
                        <h3>
                          B.Tech in Computer Science and Engineering, Minor
                          (Data Science)
                        </h3>
                        <p>CGPA - 8.05 (72.45%) </p>
                      </div>
                    ...
                    <li>
                      <div className="item">
                        <div className="item_top">
                          <h5>Udacity</h5>
                          <span>( 05/2018 - 07/2018 )</span>
                        </div>
                        <h3>Data Analyst Nanodegree</h3>
                        <p>
                          {" "}
                          The data analysis process of wrangling, exploring,
                          analyzing, and communicating data. Wrangling process
                          of gathering, assessing, and cleaning data.
                        </p>
                      </div>
                    </li>
                    <li>
                      <div className="item">
                        <div className="item_top">
                          <h5>Central Malwa Academy (ICSE/ISC)</h5>
                          <span>( 07/2011 - 05/2016 )</span>
                        </div>
                        <h3>Maths, Science</h3>
                        <p> </p>
                      </div>
              ...
              <div id="tab3" className={`tab_item ${activeList("tab3")}`}>
                ...
                <div className="resumo_fn_progress_bar">
                  ...
                  <div className="progress_item open" data-value={95}>
                    <div className="item_in">
                      <h3 className="progress_title">React &amp; Next</h3>
                      <span
                        className="progress_percent"
                        style={{ right: "0%" }}
                      >
                  ...
                  <div className="progress_item open" data-value={85}>
                    <div className="item_in">
                      <h3 className="progress_title">Deno</h3>
                      <span
                        className="progress_percent"
                        style={{ right: "0%" }}
                      >
